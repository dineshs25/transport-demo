...
//                   >
//                     <i className={`fa ${['fa-clock-o', 'fa-comments', 'fa-user', 'fa-tags', 'fa-upload', 'fa-briefcase'][num - 1]}`}></i>
//                     <span className="forActive"></span>
//                   </span>
//                 ))}
//               </div>
//               <div className="contentCircle">
//                 {['Automate', 'Chat', 'Responses', 'Tags', 'Sharing', 'Support'].map((title, index) => (
//                   <div
//                     key={index + 1}
...
//                     <i className={`fa ${['fa-clock-o', 'fa-comments', 'fa-user', 'fa-tags', 'fa-upload', 'fa-briefcase'][index]}`}></i>
//                   </div>
//                 ))}
//               </div>
//             </div>
